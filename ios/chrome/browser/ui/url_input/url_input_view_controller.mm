  ...
  - (void)viewDidLoad {
    ...
    if (self.urlField) {
      ...
      NSLog(@"URL input field configured: %@, editable: %d, can become first responder: %d, delegate: %@, preEditing: %d",
            self.urlField, self.urlField.isEnabled, [self.urlField canBecomeFirstResponder],
            self.urlField.delegate, self.urlField.isPreEditing);
  ...
  - (void)textDidChange:(NSNotification *)notification {
    ...
    NSLog(@"textDidChange, urlField text: %@", textField.text);
  }
  ...
  - (void)focusURLField:(UITapGestureRecognizer*)gesture {
    ...
    NSLog(@"URL field focused via tap, first responder: %d", [textField isFirstResponder]);
  }
  ...
  - (void)handleEditingDidBegin:(UITextField*)textField {
    ...
    NSLog(@"URL field editing began, first responder: %d", [textField isFirstResponder]);
  }
